...
public class admin_activity extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<link rel=\"stylesheet\" href=\"style_em.css\">");
            out.println("</head>");
            out.println("<body  background='admin-acti.jpg' >");
      ...
      // out.println("<br><b><a href='View_schedule'>Want to view shedule?...click here</a></b>");
            ...
            out.println("<br><br><input type='submit' value='EMPLOYEE MANAGEMENT' name='a'><br><br>");
            out.println("<input type='submit' value='PROJECT MANAGEMENT' name='b'><br><br>");
            out.println("<input type='submit' value='LEAD MANAGEMENT' name='c'><br><br>");
